...
gcloud storage cp gs://gpolovets-inference/misc/nightly-build/golden-numbers.txt ${OUTPUT_DIR}/golden-numbers.txt


## DeepSeek-v2 16B Decode accuracy checks
# ragged_dot, int8
# current_dir=$(pwd)
# cd /home/gpolovets/maxtext
python3 -m  MaxText.decode MaxText/configs/base.yml base_output_directory=results run_name=decode3-bug per_device_batch_size=1  model_name=deepseek2-16b max_prefill_predict_length=128 max_target_length=256 tokenizer_type=huggingface tokenizer_path=deepseek-ai/DeepSeek-V2-Lite attention=dot_product dtype=bfloat16 weight_dtype=bfloat16 megablox=False sparse_matmul=True ici_tensor_parallelism=1 ici_expert_parallelism=8 ici_fsdp_parallelism=1 prompt="I love to" scan_layers=False add_eos=False hf_access_token=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 load_parameters_path=gs://gpolovets-inference/deepseek/models/ds_v2/int8/unscanned checkpoint_is_quantized=true quantization=int8 async_checkpointing=false logical_axis_rules=[[activation_batch,[data,fsdp,fsdp_transpose]],[activation_batch_no_exp,[data,fsdp,fsdp_transpose]],[activation_embed_and_logits_batch,[data,stage,fsdp,fsdp_transpose]],[activation_heads,[tensor,expert,tensor_transpose,sequence,tensor_sequence]],[activation_kv_heads,[tensor,expert,tensor_transpose,sequence,tensor_sequence]],[activation_length,[sequence]],[activation_norm_length,[tensor_sequence,sequence]],[activation_embed,[tensor,tensor_transpose]],[activation_mlp,[tensor_transpose,tensor_sequence]],[activation_kv,[tensor_transpose,tensor_sequence]],[activation_prefill_kv_batch,[data,fsdp,fsdp_transpose,expert]],[activation_kv_batch,[data,fsdp,fsdp_transpose]],[activation_kv_head_dim,[tensor_transpose,tensor_sequence]],[activation_vocab,[tensor,tensor_transpose,sequence,tensor_sequence]],[activation_stage,stage],[activation_exp,expert],[mlp,[fsdp_transpose,tensor_sequence,autoregressive]],[vocab,[tensor,tensor_transpose,tensor_sequence,autoregressive]],[heads,[tensor,expert,tensor_transpose,tensor_sequence,autoregressive]],[q_heads,[tensor,expert,tensor_transpose,tensor_sequence,autoregressive]],[kv_heads,[tensor,expert,tensor_transpose,tensor_sequence,autoregressive]],[embed,[fsdp,fsdp_transpose,sequence,tensor_transpose]],[embed,[fsdp,sequence,tensor_transpose]],[embed,[fsdp,fsdp_transpose,sequence]],[embed,[fsdp,sequence]],[embed_no_exp,[fsdp,fsdp_transpose,sequence,tensor_transpose]],[embed_no_exp,[fsdp,sequence,tensor_transpose]],[embed_no_exp,[fsdp,fsdp_transpose,sequence]],[embed_no_exp,[fsdp,sequence]],[q_lora,[fsdp,sequence]],[kv_lora,[fsdp,sequence]],[norm,[tensor,tensor_transpose,tensor_sequence]],[layers,stage],[kv,[]],[kv_head_dim,[]],[cache_batch_prefill,[]],[cache_batch,[]],[cache_heads,[autoregressive,tensor,expert,tensor_transpose,tensor_sequence]],[cache_heads,[autoregressive,tensor,expert,tensor_sequence]],[cache_kv,[]],[cache_sequence,[]],[cache_scale_heads,[autoregressive,tensor,expert,tensor_sequence]],[exp,expert],[paged_kv_heads,[]],[num_pages,[tensor,expert]],[tokens_per_page,[]],[paged_kv_head_dim_size,[]]] > ${OUTPUT_DIR}/deepseekv2-16b_ragged_dot.txt
tail -n1 ${OUTPUT_DIR}/deepseekv2-16b_ragged_dot.txt > ${OUTPUT_DIR}/deepseekv2-16b_ragged_dot.tmp && mv ${OUTPUT_DIR}/deepseekv2-16b_ragged_dot.tmp ${OUTPUT_DIR}/deepseekv2-16b_ragged_dot.txt

# megablox, int8
python3 -m  MaxText.decode MaxText/configs/base.yml base_output_directory=results run_name=decode3-bug per_device_batch_size=1  model_name=deepseek2-16b max_prefill_predict_length=128 max_target_length=256 tokenizer_type=huggingface tokenizer_path=deepseek-ai/DeepSeek-V2-Lite attention=dot_product dtype=bfloat16 weight_dtype=bfloat16 megablox=True sparse_matmul=True ici_tensor_parallelism=1 ici_expert_parallelism=8 ici_fsdp_parallelism=1 prompt="I love to" scan_layers=False add_eos=False hf_access_token=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 load_parameters_path=gs://gpolovets-inference/deepseek/models/ds_v2/int8/unscanned checkpoint_is_quantized=true quantization=int8 async_checkpointing=false logical_axis_rules=[[activation_batch,[data,fsdp,fsdp_transpose]],[activation_batch_no_exp,[data,fsdp,fsdp_transpose]],[activation_embed_and_logits_batch,[data,stage,fsdp,fsdp_transpose]],[activation_heads,[tensor,expert,tensor_transpose,sequence,tensor_sequence]],[activation_kv_heads,[tensor,expert,tensor_transpose,sequence,tensor_sequence]],[activation_length,[sequence]],[activation_norm_length,[tensor_sequence,sequence]],[activation_embed,[tensor,tensor_transpose]],[activation_mlp,[tensor_transpose,tensor_sequence]],[activation_kv,[tensor_transpose,tensor_sequence]],[activation_prefill_kv_batch,[data,fsdp,fsdp_transpose,expert]],[activation_kv_batch,[data,fsdp,fsdp_transpose]],[activation_kv_head_dim,[tensor_transpose,tensor_sequence]],[activation_vocab,[tensor,tensor_transpose,sequence,tensor_sequence]],[activation_stage,stage],[activation_exp,expert],[mlp,[fsdp_transpose,tensor_sequence,autoregressive]],[vocab,[tensor,tensor_transpose,tensor_sequence,autoregressive]],[heads,[tensor,expert,tensor_transpose,tensor_sequence,autoregressive]],[q_heads,[tensor,expert,tensor_transpose,tensor_sequence,autoregressive]],[kv_heads,[tensor,expert,tensor_transpose,tensor_sequence,autoregressive]],[embed,[fsdp,fsdp_transpose,sequence,tensor_transpose]],[embed,[fsdp,sequence,tensor_transpose]],[embed,[fsdp,fsdp_transpose,sequence]],[embed,[fsdp,sequence]],[embed_no_exp,[fsdp,fsdp_transpose,sequence,tensor_transpose]],[embed_no_exp,[fsdp,sequence,tensor_transpose]],[embed_no_exp,[fsdp,fsdp_transpose,sequence]],[embed_no_exp,[fsdp,sequence]],[q_lora,[fsdp,sequence]],[kv_lora,[fsdp,sequence]],[norm,[tensor,tensor_transpose,tensor_sequence]],[layers,stage],[kv,[]],[kv_head_dim,[]],[cache_batch_prefill,[]],[cache_batch,[]],[cache_heads,[autoregressive,tensor,expert,tensor_transpose,tensor_sequence]],[cache_heads,[autoregressive,tensor,expert,tensor_sequence]],[cache_kv,[]],[cache_sequence,[]],[cache_scale_heads,[autoregressive,tensor,expert,tensor_sequence]],[exp,expert],[paged_kv_heads,[]],[num_pages,[tensor,expert]],[tokens_per_page,[]],[paged_kv_head_dim_size,[]]] > ${OUTPUT_DIR}/deepseekv2-16b_megablox.txt
tail -n3 ${OUTPUT_DIR}/deepseekv2-16b_megablox.txt > ${OUTPUT_DIR}/deepseekv2-16b_megablox.tmp && mv ${OUTPUT_DIR}/deepseekv2-16b_megablox.tmp ${OUTPUT_DIR}/deepseekv2-16b_megablox.txt
# tail -n3 ${OUTPUT_DIR}/deepseekv2-16b_megablox.txt > ${OUTPUT_DIR}/deepseekv2-16b_megablox.tmp && mv ${OUTPUT_DIR}/deepseekv2-16b_megablox.tmp ${OUTPUT_DIR}/deepseekv2-16b_megablox_final.txt
# cd $current_dir
